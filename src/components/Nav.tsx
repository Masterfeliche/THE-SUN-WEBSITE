      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 16px" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ width: 40, height: 40, borderRadius: "999px", display: "flex", alignItems: "center", justifyContent: "center", background: "#ff7a1a" }}>
              <span style={{ fontWeight: 800, color: "#000" }}>☀</span>
            </div>
            <NavLink to="/" style={{ color: "#fff", fontWeight: 700, fontSize: 18, textDecoration: "none" }}> <span style={{ color: "#ffb28a" }}>The</span> Sun</NavLink>
          </div>

          {/* Desktop links */}
          <nav className="hidden md:flex" aria-label="Main navigation" style={{ gap: 8, display: "flex", alignItems: "center" }}>
        ...
        {open && (
          <div className="md:hidden" style={{ padding: "8px 0", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
            <nav style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              <NavLink to="/" onClick={() => setOpen(false)} style={{ ...linkStyle, display: "block" }}>Home</NavLink>
              <NavLink to="/about" onClick={() => setOpen(false)} style={{ ...linkStyle, display: "block" }}>About</NavLink>
              <NavLink to="/programs" onClick={() => setOpen(false)} style={{ ...linkStyle, display: "block" }}>Programs</NavLink>
              <NavLink to="/blog" onClick={() => setOpen(false)} style={{ ...linkStyle, display: "block" }}>Blog</NavLink>
              <NavLink to="/contact" onClick={() => setOpen(false)} style={{ ...linkStyle, display: "block" }}>Contact</NavLink>
